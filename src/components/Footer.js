        ...
        <Card className="theme-settings">
          <Card.Body className="pt-4">
            ...
            <div className="d-flex justify-content-between align-items-center mb-3">
              ...
              <GitHubButton href="https://github.com/themesberg/robot-react-dashboard" data-size="large" data-show-count="true" aria-label="Star themesberg/robot-react-dashboard on GitHub">Star</GitHubButton>
            </div>
            <Button href="https://themesberg.com/product/dashboard/robot-react" target="_blank" variant="primary" className="mb-3 w-100"><FontAwesomeIcon icon={faDownload} className="me-1" /> Download</Button>
            <p className="fs-7 text-gray-700 text-center">Available in the following technologies:</p>
            <div className="d-flex justify-content-center">
              <Card.Link href="https://themesberg.com/product/admin-dashboard/robot-bootstrap-5-dashboard" target="_blank">
              ...
              <Card.Link href="https://themesberg.com/product/dashboard/robot-react" target="_blank">
              ...
              <Card.Link href="https://themesberg.com/product/laravel/robot-admin-dashboard-template" target="_blank">
