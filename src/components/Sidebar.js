        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="Sanitized Robot" link={Routes.Signin.path} image={ReactHero} />
              ...
              <NavItem external title="ThemSesberg" link="https://themesberg.com" target="_blank" image={ThemesbergLogo} />
