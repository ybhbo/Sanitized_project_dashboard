...
//                     <p className="text-center lead mb-lg-5 mb-4">Looking to take React development to the next level? Check out the premium version of robot React Dashboard.</p>
...
//                                     <Button href="https://themesberg.com/product/dashboard/robot-react" target="_blank" variant="primary" className="m-0 mt-3 mb-3"><FontAwesomeIcon icon={faDownload} className="me-1" /> Download</Button>
//                                 </td>
//                                 <td className="border-0">
//                                     <Button href="https://demo.themesberg.com/robot-pro-react/#/" target="_blank" variant="secondary" className="m-0 mt-3">Demo robot React Pro <FontAwesomeIcon icon={faExternalLinkAlt} className="ms-1" /></Button>
//                                 </td>
//                             </tr>
//                         </tbody>
//                     </Table>
