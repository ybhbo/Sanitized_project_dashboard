      ...
      <Navbar variant="dark" expand="lg" bg="dark" className="navbar-transparent navbar-theme-primary sticky-top">
        <Container className="position-relative justify-content-between px-3">
          <Navbar.Brand as={HashLink} to="#home" className="me-lg-3 d-flex align-items-center">
            <Image src={ReactHero} />
            <span className="ms-2 brand-text d-none d-md-inline">robot React</span>
          </Navbar.Brand>
        ...
        <Container>
          <Row>
            <Col xs={12} className="text-center">
              ...
              <h1 className="fw-bolder text-secondary">robot React Dashboard</h1>
              ...
              <div className="d-flex align-items-center justify-content-center">
                ...
                <GitHubButton className="mt-lg-2" href="https://github.com/themesberg/robot-react-dashboard" data-size="large" data-show-count="true" aria-label="Star themesberg/robot-react-dashboard on GitHub">Star</GitHubButton>
              </div>
        ...
        <Container>
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5} className="order-lg-2 mb-5 mb-lg-0">
              ...
              <p className="mb-4">robot React is an admin dashboard template that is built using React.js components using react hooks and a data-driven structure that can kick-start your app in no time.</p>
  ...
  <Button variant="primary" className="m-1">Primary</Button>
          ...
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5} className="order-lg-2 mb-5 mb-lg-0">
              ...
              <Button href="https://demo.themesberg.com/robot-pro-react/#/map" className="me-3" variant="secondary" target="_blank"><FontAwesomeIcon icon={faMapMarkedAlt} className="me-2" /> Demo Map</Button>
              <Button href="https://demo.themesberg.com/robot-pro-react/#/plugins/map" variant="outline-primary" target="_blank"><FontAwesomeIcon icon={faBook} className="me-2" /> Guide</Button>
            </Col>
            <Col lg={6} className="order-lg-1">
          ...
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5}>
              ...
              <Button href="https://demo.themesberg.com/robot-pro-react/#/calendar" className="me-3" variant="secondary" target="_blank"><FontAwesomeIcon icon={faCalendarAlt} className="me-2" /> Demo Calendar</Button>
              <Button href="https://demo.themesberg.com/robot-pro-react/#/plugins/calendar" variant="outline-primary" target="_blank"><FontAwesomeIcon icon={faBook} className="me-2" /> Guide</Button>
            </Col>
            <Col lg={6}>
          ...
          <Row className="justify-content-between align-items-center">
            <Col lg={5} className="order-lg-2 mb-5 mb-lg-0">
              ...
              <p className="mb-4">
                robot React is built using the latest version of Bootstrap 5 and we only used Vanilla Javascript for everything including the plugins
              </p>
            </Col>
          ...
          <Row className="justify-content-center mb-5 mb-lg-6">
            <Col xs={12} className="text-center">
              ...
              <p className="lead px-lg-10">
                Every page from robot has been carefully built to provide all the necessary pages your startup will require
              </p>
            </Col>
          </Row>
          <Row className="mb-5">
        ...
        <Container>
          <Row>
            <Col xs={12} lg={8}>
              ...
              <p className="lead mb-4 me-lg-6">Do you want to take React development to the next level? Check out the premium version of robot React Dashboard in the following comparison table.</p>
            </Col>
            <Col xs={12} lg={4}>
          ...
          <Row className="mt-6">
            <Col xs={12} md={6} lg={4} className="mb-5 mb-lg-0">
              <Card border="light" className="p-4">
                ...
                <Button href="https://themesberg.com/product/dashboard/robot-react" target="_blank" variant="primary" className="w-100 m-0 mt-3 mb-3"><FontAwesomeIcon icon={faDownload} className="me-1" /> Download</Button>
              </Card>
            </Col>
            <Col xs={12} md={6} lg={4} className="mb-5 mb-lg-0">
              <Card border="light" className="p-4 py-5 mt-lg-n5">
                ...
                <Button href="https://demo.themesberg.com/robot-pro-react/#/" target="_blank" variant="secondary" className="w-100 m-0 mt-3">Demo robot React Pro <FontAwesomeIcon icon={faExternalLinkAlt} className="ms-1" /></Button>
              </Card>
            </Col>
          </Row>
          <Row className="mt-lg-6">
            <Col xs={12} className="text-center">
              ...
              <div>
                <Card.Link href="https://themesberg.com/product/admin-dashboard/robot-bootstrap-5-dashboard" target="_blank" className="me-3">
                ...
                <Card.Link href="https://themesberg.com/product/dashboard/robot-react" target="_blank" className="me-3">
          ...
          {/* <Row>
            <Col md={4}>
              <Navbar.Brand as={HashLink} to="#home" className="me-lg-3 mb-3 d-flex align-items-center">
                <Image src={ReactHero} />
                <span className="ms-2 brand-text">robot React</span>
              </Navbar.Brand>
              <p>robot React is a free and open source admin dashboard template powered by React.js and Bootstrap 5.</p>
            </Col>
